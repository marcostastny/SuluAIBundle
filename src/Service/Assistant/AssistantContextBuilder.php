...
class AssistantContextBuilder
{
    ...
    private function navigationGuidance(): string
    {
        return <<<'GUIDANCE'
            ...
            - If a search returns no results, do not give up after one attempt: retry with broader or related terms - a synonym, the likely page or section title, or a single distinctive word. Only tell the user you found nothing after several differently-worded searches.
